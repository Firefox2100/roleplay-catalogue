...
import { PresetEditorPage } from './pages/PresetEditorPage.jsx'
import { PresetDetailPage } from './pages/PresetDetailPage.jsx'
import './App.css'
    ...
    <AuthProvider>
      <Routes>
        <Route element={<Layout />}>
          ...
          <Route path="presets/:resourceId/edit" element={<PresetEditorPage />} />
