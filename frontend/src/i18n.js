...
const translations = {
  [ENGLISH]: { translation: {
    ...
    home: {
      ...
      tabs: { all: 'All', characters: 'Characters', lorebooks: 'Lorebooks', images: 'Images', worlds: 'Worlds' },
    ...
    editor: {
      ...
      linkedLorebooks: 'Linked lorebooks', linkedLorebooksHelp: 'Select standalone lorebooks to associate with this card. Their entries are merged into downloads after the private embedded lorebook. Publishing requires each linked lorebook to have a release at least as visible as the character.',
  ...
  [CHINESE]: { translation: {
    ...
    home: {
      ...
      tabs: { all: '全部', characters: '角色卡', lorebooks: '世界书', images: '图片', worlds: '模拟世界' },
    ...
    editor: {
      ...
      linkedLorebooks: '关联世界书', linkedLorebooksHelp: '选择要与此角色卡关联的独立世界书。下载时，其条目会合并到角色私有内嵌世界书之后。发布角色前，每个关联世界书都必须已有发布版本，且可见范围不得低于角色。',
