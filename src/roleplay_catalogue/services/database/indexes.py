...
INDEXES: tuple[IndexDefinition, ...] = (
    ...
    IndexDefinition('resources', 'resources_linked_lorebook_refs_v2', [('linkedLorebooks.resourceId', ASCENDING)], {}),
    IndexDefinition('resource_versions', 'versions_linked_lorebooks', [('linkedLorebooks.versionId', ASCENDING)], {}),
    IndexDefinition(
    ...
    IndexDefinition('sillytavern_preset_data', 'preset_data_id_unique', [('id', ASCENDING)], {'unique': True}),
    IndexDefinition('sillytavern_preset_data', 'preset_data_resource', [('resourceId', ASCENDING)], {}),
    IndexDefinition('sillytavern_preset_data', 'preset_data_version', [('resourceVersionId', ASCENDING)], {}),
